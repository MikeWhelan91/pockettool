  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        <div>
          <label className="block text-sm text-neutral-300 mb-1">Transform</label>
          <select
            className="input"
            value={mode}
      ...
      <div className="card">
        ...
        <ul className="list-disc ml-6 text-neutral-300">
          <li>Slug removes accents and symbols, then lowercases and joins with dashes.</li>
          <li>Title case capitalizes each word; Sentence case capitalizes sentence starts.</li>
